...
const commitments: Commitment[] = [
  {
    ...
    description: "We take full responsibility for our work. No finger-pointing. If a plumbing challenge arises, Robert and his team solve it.",
  ...
  },
  {
    ...
    description: "Clear communication. Honest, upfront pricing. No hidden fees. You stay informed from the first leak to the final pipe.",
  ...
  },
  {
    ...
    description: "We treat your home as if it were our own. Protective floor coverings and spotless cleanup are mandatory on every job.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"></path><path d="M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path></svg>
  },
  {
    title: "Precision Execution",
    description: "From simple faucet installs to complex replacements, our craftsmanship is measured by long-term durability, not quick fixes.",
  ...
  },
  {
    ...
    description: "We respect your time. We set narrow arrival windows and work diligently to restore your water and comfort as fast as possible.",
  ...
  },
  {
    ...
    description: "Our relationship doesn’t end when the bill is paid. We stand behind our plumbing work with solid, local guarantees.",
    ...
    <section id="commitments" className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:flex justify-between items-end">
          <div>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight mb-4">The Robert’s Standard</h2>
            <p className="text-neutral-500 max-w-md font-dm-sans">Our reputation is built on what we do when no one is watching.</p>
          </div>
        </div>
