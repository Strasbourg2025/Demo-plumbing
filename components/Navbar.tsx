  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'glass-nav border-b border-neutral-200/50 h-16' : 'bg-transparent h-20'}`}>
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        <a href="#" className="text-lg font-semibold tracking-widest uppercase">Your Ideal Home.</a>
        
        <div className="hidden md:flex gap-8 text-sm font-medium text-neutral-500">
          <a href="#commitments" className="transition-colors hover:text-neutral-900 font-dm-sans">Standard</a>
          <a href="#services" className="transition-colors hover:text-neutral-900 font-dm-sans">Services</a>
          <a href="#process" className="transition-colors hover:text-neutral-900 font-dm-sans">Process</a>
        </div>
